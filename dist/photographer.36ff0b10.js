 ...
 */ class ViewVideo {
    constructor(_ref){
        let { name , id , firstName , title , altText  } = _ref;
        this.id = id;
        this.name = name;
        this.firstName = firstName;
        this.title = title;
...
class ViewPictures {
    ...
    toString() {
        return "\n        <img src=\"./assets/images/Sample_Photos/".concat(this.firstName, "/").concat(this.name, "\" id=\"").concat(this.id, "\" alt=\"").concat(this.altText, ": ").concat(this.title, "\" class=\"image media\" tabindex=\"0\">");
    }
}
exports.default = ViewPictures;

},{}],"guRfF":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});

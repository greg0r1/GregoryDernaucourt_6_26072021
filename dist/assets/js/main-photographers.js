...
// import images from '../images/Sample Photos/Photographers ID Photos/*.jpg';
// const images = require('./images/Sample Photos/Photographers ID Photos/MimiKeel.jpg.jpg');
        ...
        <article class="article">
            <a class="link-to-photographer" href="#" alt="" aria-label="Lien vers le photographe" focusable="true">
                <div class="article__img" aria-label="Image">
                    <img src="./src/assets/images/Sample Photos/Photographers ID Photos/${portrait}" alt="">
                </div>
